class ForumsController < ApplicationController
  ...
  # GET /forums/1.xml
  def show
    redirect_to root_url and return unless @forum = forums.find_by_permalink(params[:id])
  ...
  # GET /forums/1/edit
  def edit
    @forum = forums.find_by_permalink(params[:id])
  end

  # POST /forums
  # POST /forums.xml
  def create
    @forum = forums.build(params[:forum])
